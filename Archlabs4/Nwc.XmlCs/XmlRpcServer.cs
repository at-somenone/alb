    ...
    public class XmlRpcServer: IEnumerable
    {
        ...
        public void Stop() {
            try {
                ...
                Logger.WriteEntry("An Exception Occurred while stopping :" + e, LogLevel.Error);
            }
        }
        ...
        public string MethodName(string methodName) {
            ...
            if (target == null) {
                throw new XmlRpcException(XmlRpcErrorCodes.SERVER_ERROR_METHOD,
                                          XmlRpcErrorCodes.SERVER_ERROR_METHOD_MSG
                                        + ": Object "
                                        + objectName
                                        + " not found");
            }
        ...
        public void WaitCallback(object responder) {
            ...
            if (resp.HttpReq.HttpMethod == "POST") {
                ...
                Logger.WriteEntry("Only POST methods are supported: " + resp.HttpReq.HttpMethod + " ignored",
                                  LogLevel.Error);
            }
